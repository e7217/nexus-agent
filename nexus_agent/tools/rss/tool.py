...
class RSSFeederTool(BaseTool):
    ...
    name: str = "rss_feeder"
    description: str = "Useful when you need to get the latest news from a specific RSS feed."
    ...
    extract_content: bool = Field(description="Whether to extract the content of the article.", default=True)
    nlp: bool = Field(description="Whether to use NLP to extract the content of the article.", default=False) # This is for newspaper3k
